...
const NAV: Record<Role, NavItem[]> = {
  administrador: [
    ...
    { label: 'Usuários',     href: '/crm/admin/usuarios' },
    { label: 'Consultorias', href: '/crm/admin/consultorias' },
    { label: 'Compradores',  href: '/crm/admin/compradores' },
    { label: 'Relatórios',   href: '/crm/admin/relatorios' },
  ],
  consultora: [
    { label: 'Dashboard',     href: '/crm/consultora' },
    { label: 'Meus Clientes', href: '/crm/consultora/clientes' },
    { label: 'Agenda',        href: '/crm/consultora/agenda' },
    { label: 'Produtos',      href: '/crm/consultora/produtos' },
    { label: 'Pedidos',       href: '/crm/consultora/pedidos' },
  ],
  comprador: [
    { label: 'Dashboard',    href: '/crm/comprador' },
    { label: 'Catálogo',     href: '/crm/comprador/catalogo' },
    { label: 'Carrinho',     href: '/crm/comprador/carrinho' },
    { label: 'Meus Pedidos', href: '/crm/comprador/pedidos' },
  ],
}
